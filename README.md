...
> Web Development & Designing Internship Projects

This repository contains my projects and learning work completed during my **Oasis Infobyte (OIBSIP) Web Development & Designing Internship**.

The main purpose of this repository is to document my practical learning journey, including the projects I developed, technologies I used, challenges I faced, solutions I implemented, and the concepts I learned throughout the internship.
...
During this internship, I worked on multiple web development projects using HTML, CSS, and JavaScript. Through these tasks, I focused on improving my frontend development skills, responsive design, user interface development, JavaScript logic, validation, and Git/GitHub workflow.
...
- Learn and improve practical web development skills.
- Build real-world style web projects.
- Understand how HTML, CSS, and JavaScript work together.
- Create responsive and user-friendly interfaces.
- Practice writing clean and structured code.
- Improve problem-solving and debugging skills.
- Learn how to use Git and GitHub for project management.
- Document projects professionally.
- Gain experience presenting projects through demo videos.
- Improve communication and professional development through LinkedIn.

---

# 🚀 Projects Completed

| Task | Project | Technologies | Main Focus |
|------|---------|--------------|------------|
| L1-T1 | KAGE//STREET Landing Page | HTML, CSS | Landing Page & Responsive Design |
| L1-T2 | Personal Portfolio | HTML, CSS | Portfolio / Digital Resume |
| L1-T3 | TempX Temperature Converter | HTML, CSS, JavaScript | JavaScript Logic & Validation |
...
# 🌡️ Task 3 — TempX Temperature Converter

## 📌 Project Overview

TempX is an interactive temperature conversion web application built using HTML, CSS, and vanilla JavaScript.

The application allows users to enter a temperature and select Celsius, Fahrenheit, or Kelvin as the input unit. It then calculates and displays the corresponding values for all three units.
...
- Responsive UI
- Enter-key support
- Results displayed in separate cards
